...
from flaskTest.views.data_views.total_views import get_total_by_material, get_total_desc_by_material, \
    ...
    get_total_desc_by_material_and_keyanliang, get_total_by_material_and_stars, get_total_desc_by_material_and_stars
...
def do_analysis_one_material_plant_group_by_stars(material, start_time, end_time, stars):

    # 获取该商品的销量数据、油站信息、poi信息、促销信息等，用于模型训练（已编码）
    data = get_total_by_material_and_stars(material, start_time, end_time, stars)
    ...
    data_desc = get_total_desc_by_material_and_stars(material, start_time, end_time, stars)
    # 更改列名
...
do_analysis_one_material_plant_group_by_stars('000000000070251989', '2019-09-01', '2019-12-01', '五星级')